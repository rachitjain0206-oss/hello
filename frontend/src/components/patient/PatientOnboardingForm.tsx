...
const PatientOnboardingForm = () => {
  ...
  const handleEmergenyContactChange = (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      handleEmergenyContactChange("name", e.target.value)
                    }
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      handleEmergenyContactChange("phone", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleEmergenyContactChange("relationship", value)
                    }
                  >
                    <SelectTrigger>
